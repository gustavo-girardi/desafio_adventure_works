with
    ...
    ,renomeado as (
        select 
            ...
            , cast(source_salesorderdetail.unitprice as numeric(18,4)) as unitprice
            , cast(source_salesorderdetail.unitpricediscount as numeric(18,4)) as unitpricediscount
